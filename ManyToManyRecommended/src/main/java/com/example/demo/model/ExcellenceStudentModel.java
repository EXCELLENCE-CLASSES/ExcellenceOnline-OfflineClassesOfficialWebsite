...
public class ExcellenceStudentModel {
	...
	//Note(Self):without using mapped ,getting better outcome(information in database).
	         @ManyToMany(cascade=CascadeType.ALL,mappedBy="excModel")
	        
             private Set<ExcellenceClassesModel> exc=new HashSet<>() ;
